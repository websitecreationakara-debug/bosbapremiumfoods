...
export const wagyuEn = {
  ...
  "faq.q5.a":
    "Properly stored in your freezer at -18°C or below, Japanese Wagyu can be kept for up to 1-2 years without any loss of quality. Once thawed in the refrigerator (24 hours), cook within 2–3 days for the best experience.",
...
const km: Dict = {
  ...
  "faq.q1.q": "ហេតុអ្វីបានជាគោ Wagyu របស់ជប៉ុនមានតម្លៃថ្លៃម្ល៉េះ?",
  "faq.q1.a":
    "សាច់គោ Wagyu របស់ជប៉ុនត្រូវបានចិញ្ចឹមរយៈពេលជាង 30 ខែ ក្រោមវិន័យយ៉ាងតឹងរ៉ឹង យូរជាងសាច់គោធម្មតាជិតបីដង។ ការផ្តល់ចំណីយ៉ាងហ្មត់ចត់ បរិយាកាសគ្មានភាពតានតឹង និងផលិតកម្មដែលមានកំណត់នៃការផលិត អាចឆ្លុះបញ្ចាំងទៅលើតម្លៃ។ បងៗកំពុងចំណាយទៅលើកាតទទួលនូវបទពិសោធន៍ដែលមិនអាចភ្លេចបាន។",
  "faq.q2.q": "តើ​អ្វី​ទៅ​ជា​ភាព​ខុស​គ្នា​រវាង​សាច់​គោ Wagyu A4 និង A5?",
  "faq.q2.a":
    "ទាំង​ពីរ​សុទ្ធតែជាសាច់គោដែលមានគុណភាពខ្ពស់ទាំងពីរ ប៉ុន្តែ A5 តំណាង​ឲ្យ​ចំណាត់ថ្នាក់នៃសាច់គោដែលខ្ពស់បំផុត។ A4 មាន BMS (Beef Marbling Score) ពី 6–8 ដែល​ផ្តល់​នូវ​រសជាតិ​ដ៏​សម្បូរបែប​ជាមួយ​នឹង​ខ្លាញ់ដែលផ្ដល់នូវរសជាតិដ៏សម្បូរបែប។ A5 មានBMS 9–12 ជាមួយ​នឹង​ខ្លាញ់​ក្នុង​សាច់​ដែលធ្វើអោយរលាយក្នុងមាត់ និងពោរពេញដោយ umami។",
  "faq.q3.q": "តើខ្ញុំគួរចម្អិនសាច់ Wagyu ជប៉ុននៅផ្ទះដោយរបៀបណា?",
  "faq.q3.a":
    "សាមញ្ញបំផុត ដោយយកសាច់គោជប៉ុន (Wagyu) ចេញពីទូរទឹកក កកគ្រន់តែយកមកដាក់ខាងក្រៅ ក្នុងសីតុណ្ហភាពបន្ទប់ធម្មតា រយៈពេល 30-40នាទី មុនពេលចម្អិន។ កម្ដៅខ្ទះអោយក្ដៅ មិនចាំបាច់ក្នុងការប្រើខ្លាញ់នោះទេ ខ្លាញ់ដែលចេញពីសាច់នឹងរលាយភ្លាមៗពេលដាច់សាច់ចូលក្នុងខ្ទះ ចម្អិនដោយប្រើ 30-60 វិនាទី ក្នុងការប្រែសាច់ពីម្ខាងទៅម្ខាងទៀត សម្រាប់ A4 និងប្រើពលដល់ 90វិនាទី សម្រាប់ A5 ទុកសាច់ចោលរយៈពេល 2-3 នាទី បន្ទាប់មកអាចហាន់ជាចំណិតទុចល្មម ដើម្បីទទួលបានរសជាតិដ៏សម្បូរបែបនៃសាច់។",
  "faq.q4.q": "តើ Wagyu ត្រូវបានដឹកជញ្ជូនយ៉ាងដូចម្តេច?",
  "faq.q4.a":
    "ដឹកជញ្ជូនក្នុងការវេចខ្ចប់ដែលមានការរៀបចំដាក់ក្នុងឡាំងដែលមាននូវទឹកកត្រឹមត្រូវ ដើម្បីរក្សារសីតុណ្ហភាព និង គុណភាព លើសពីនេះក៏មានការថែមជូននូវទឹកជ្រលក់ BBQ និង ម្រេចខ្មៅមួយឈុតផងដែរ",
  "faq.q5.q": "តើសាច់ Wagyu អាចរក្សារទុយបានរយៈពេលប៉ុន្មាន?",
  "faq.q5.a":
    "ប្រសិនបើរក្សាទុកឱ្យបានត្រឹមត្រូវនៅក្នុងទូរទឹកកករបស់អ្នកនៅសីតុណ្ហភាព -18°C ឬទាបជាងនេះ សាច់ Wagyu ជប៉ុនអាចរក្សាទុកបានរហូតដល់ 1-2 ឆ្នាំ ដោយមិនបាត់បង់គុណភាព។ នៅពេលដែលរលាយក្នុងទូរទឹកកក (24 ម៉ោង) សូមចម្អិនក្នុងរយៈពេល 2-3 ថ្ងៃសម្រាប់គុណភាព និង បទពិសោធន៍ដ៏ល្អបំផុត។",
  "faq.q6.q": "តើប្រភពដើមនៃសាច់ Wagyu របស់អ្នកមានលិខិតបញ្ជាក់ត្រឹមត្រូវដែរឬទេ?",
  "faq.q6.a":
    "សាច់ Wagyu ទាំងអស់របស់យើងត្រូវបានយកមកពីកសិដ្ឋានជប៉ុន ដែលមានវិញ្ញាបនបត្រ និង ត្រូវបានវាយតម្លៃដោយសមាគមវាយតម្លៃសាច់ជប៉ុន (JMGA)។ ខាងយើងមានឯកសារតាមដានពេញលេញជាមួយនឹង ការបញ្ជាទិញនីមួយៗ រួមទីតាំងផលិត (ខេត្តមីយ៉ាហ្សាគិ) និង វិញ្ញាបនបត្រវាយតម្លៃផ្លូវការ។",
  "finalCta.eyebrow": "ចាប់ផ្តើមដំណើររបស់អ្នក",
  "finalCta.title.pre": "ត្រៀមខ្លួនរួចរាល់ឬនៅដើម្បីទទួលយកបទពិសោធន៍",
  "finalCta.title.em": "សាច់គោ Wagyu ជប៉ុនពិតប្រាកដ?",
  "finalCta.body":
    "មិនមែនសាច់គោទាំងអស់សុទ្ធតែត្រូវបានបង្កើតឡើងដូចគ្នានោះទេ។ នេះជាភស្តុតាង។ ស្វែងយល់ពីការប្រមូលផ្ដុំសាច់គោ Wagyu ជប៉ុនដែលមានវិញ្ញាបនបត្រ A4 និង A5 របស់យើង ផ្តល់ជូនដោយយកចិត្តទុកដាក់ ការគោរព និងការធានានូវគុណភាពនៃភាពអស្ចារ្យ។",
