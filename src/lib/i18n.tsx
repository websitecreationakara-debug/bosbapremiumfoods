...
const en = {
  ...
  "nav.megaWagyu": "Wagyu & Meats",
  "nav.megaSeafood": "Seafood & Sashimi",
  "nav.megaOccasion": "Shop by Occasion",
  "nav.megaPantry": "Pantry & Sake",
...
const km: Dict = {
  ...
  "nav.megaWagyu": "វ៉ាហ្គីយូ និងសាច់",
  "nav.megaSeafood": "អាហារសមុទ្រ និងសាស៊ីមី",
  "nav.megaOccasion": "ទិញតាមឱកាស",
  "nav.megaPantry": "គ្រឿងផ្សំ និងសាកេ",
...
const ja: Dict = {
  ...
  "nav.megaWagyu": "和牛・肉類",
  "nav.megaSeafood": "海鮮・刺身",
  "nav.megaOccasion": "シーン別に探す",
  "nav.megaPantry": "食材・日本酒",
