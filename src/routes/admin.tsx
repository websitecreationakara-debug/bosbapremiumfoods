...
import { LayoutDashboard, Package, Tag, ShoppingCart, Settings, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen flex bg-sidebar">
      <aside className="w-64 border-r border-sidebar-border p-6 flex flex-col gap-8 shrink-0">
        <Link to="/" className="flex items-center gap-2">
          <div className="size-9 rounded-lg bg-brand text-brand-foreground grid place-items-center font-display font-bold">V</div>
          <span className="font-display text-lg font-bold text-sidebar-foreground">Verdant Admin</span>
        </Link>
        ...
        <Link to="/" className="flex items-center gap-2 text-xs text-sidebar-foreground/60 hover:text-sidebar-foreground">
