...
// (edge-injected), planifyx = webchat widget, salesmartly = live chat widget,
...
const CSP = [
  ...
  "form-action 'self'",
  "script-src 'self' 'unsafe-inline' https://www.google.com https://www.gstatic.com https://analytics.tiktok.com https://static.cloudflareinsights.com https://botcommerce.planifyx.com https://plugin-code.salesmartly.com",
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "font-src 'self' data: https://fonts.gstatic.com",
  "img-src 'self' data: blob: https:",
  "connect-src 'self' https://nominatim.openstreetmap.org https://www.google.com https://analytics.tiktok.com https://static.cloudflareinsights.com https://cloudflareinsights.com https://plugin-code.salesmartly.com wss://plugin-code.salesmartly.com",
  "frame-src 'self' https://www.google.com https://botcommerce.planifyx.com https://plugin-code.salesmartly.com",
